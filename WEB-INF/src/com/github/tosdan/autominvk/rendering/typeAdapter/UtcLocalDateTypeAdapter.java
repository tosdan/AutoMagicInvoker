...
public class UtcLocalDateTypeAdapter extends TypeAdapter<LocalDate> {
	   ...
	   */
	  private static String format(LocalDate localDate, boolean millis, TimeZone tz) {
	   ...
	   */
	  private static LocalDate parse(String date, ParsePosition pos) throws ParseException {
		...
		LocalDate retval = zonedDateTime.toLocalDate();
		return retval;
	  }
}
